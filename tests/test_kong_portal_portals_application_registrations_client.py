...
def test_list_200_generated_success():
    """Tests a GET request to the /portals/{portalId}/application-registrations endpoint.
    ...
    response = client.kong_portal.portals.application_registrations.list(
...
async def test_await_list_200_generated_success():
    ...
    response = await client.kong_portal.portals.application_registrations.list(
        portal_id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a", page_number=1, page_size=10
    )
    try:
        pydantic.TypeAdapter(

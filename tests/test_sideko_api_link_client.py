...
def test_reorder_200_success_default():
    ...
    response = client.sideko.api_link.reorder(
...
async def test_await_reorder_200_success_default():
    ...
    response = await client.sideko.api_link.reorder(
        doc_version_id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a",
        groups=[{"id": "3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a", "order": 123}],
        links=[
            {
...
def test_create_201_success_default():
    ...
    response = client.sideko.api_link.create(
        doc_version_id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a",
        group_id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a",
        nav_label="string",
...
async def test_await_create_201_success_default():
    ...
    response = await client.sideko.api_link.create(
        doc_version_id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a",
        group_id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a",
        nav_label="string",
        policy={"api_id": "my-api", "type_": "latest"},
...
def test_patch_200_success_default():
    ...
    response = client.sideko.api_link.patch(id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a")
    try:
        pydantic.TypeAdapter(models.ApiLink).validate_python(response)
        is_json = True
    except pydantic.ValidationError:
...
async def test_await_patch_200_success_default():
    ...
    response = await client.sideko.api_link.patch(
        id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a"
    )
    try:
        pydantic.TypeAdapter(models.ApiLink).validate_python(response)
...
def test_get_200_generated_success():
    ...
    response = client.sideko.api_link.get(id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a")
    try:
        pydantic.TypeAdapter(models.ApiLink).validate_python(response)
        is_json = True
    except pydantic.ValidationError:
...
async def test_await_get_200_generated_success():
    ...
    response = await client.sideko.api_link.get(
        id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a"
    )
    try:
        pydantic.TypeAdapter(models.ApiLink).validate_python(response)
...
def test_list_200_generated_success():
    ...
    response = client.sideko.api_link.list(
...
async def test_await_list_200_generated_success():
    ...
    response = await client.sideko.api_link.list(
        doc_name="my-project", doc_version="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a"
    )
    try:
        pydantic.TypeAdapter(typing.List[models.ApiLink]).validate_python(response)
...
def test_delete_204_generated_success():
    ...
    response = client.sideko.api_link.delete(id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a")
...
async def test_await_delete_204_generated_success():
    ...
    response = await client.sideko.api_link.delete(
        id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a"
    )
    assert response is None

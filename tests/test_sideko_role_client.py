...
def test_create_201_success_default():
    ...
    response = client.sideko.role.create(
...
async def test_await_create_201_success_default():
    ...
    response = await client.sideko.role.create(
        object_id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a",
        object_type="api_project",
        role_definition_id="ApiProjectAdmin",
        user_id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a",
...
def test_list_200_generated_success():
    ...
    response = client.sideko.role.list()
    try:
...
async def test_await_list_200_generated_success():
    ...
    response = await client.sideko.role.list()
    try:
        pydantic.TypeAdapter(typing.List[models.Role]).validate_python(response)
        is_json = True
    except pydantic.ValidationError:
...
def test_delete_204_generated_success():
    ...
    response = client.sideko.role.delete(id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a")
...
async def test_await_delete_204_generated_success():
    ...
    response = await client.sideko.role.delete(

...
def test_update_200_success_example_1():
    """Tests a PUT request to the /portals/{portalId}/assets/favicon endpoint.
    ...
    response = client.kong_portal.portals.assets.favicon.update(
...
async def test_await_update_200_success_example_1():
    ...
    response = await client.kong_portal.portals.assets.favicon.update(
        data="data:image/png;base64,bmljZV9sb29raW5nX3BpY3R1cmU=",
        portal_id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a",
        filename="logo.png",
    )
...
def test_list_200_generated_success():
    """Tests a GET request to the /portals/{portalId}/assets/favicon endpoint.
    ...
    response = client.kong_portal.portals.assets.favicon.list(
        portal_id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a"
    )
    is_binary = isinstance(response, BinaryResponse)
    assert is_binary, "failed response type check"
...
async def test_await_list_200_generated_success():
    ...
    response = await client.kong_portal.portals.assets.favicon.list(
        portal_id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a"
    )
    is_binary = isinstance(response, BinaryResponse)
    assert is_binary, "failed response type check"

...
def test_create_201_success_default():
    ...
    response = client.sideko.doc.create(name="my-company-docs")
    try:
...
async def test_await_create_201_success_default():
    ...
    response = await client.sideko.doc.create(name="my-company-docs")
    try:
        pydantic.TypeAdapter(models.DocProject).validate_python(response)
        is_json = True
    except pydantic.ValidationError:
...
def test_patch_200_success_default():
    ...
    response = client.sideko.doc.patch(doc_name="my-project", name="my-company-docs")
    try:
        pydantic.TypeAdapter(models.DocProject).validate_python(response)
        is_json = True
    except pydantic.ValidationError:
...
async def test_await_patch_200_success_default():
    ...
    response = await client.sideko.doc.patch(
        doc_name="my-project", name="my-company-docs"
    )
    try:
        pydantic.TypeAdapter(models.DocProject).validate_python(response)
        is_json = True
...
def test_check_preview_200_generated_success():
    ...
    response = client.sideko.doc.check_preview(
...
@pytest.mark.asyncio
async def test_await_check_preview_200_generated_success():
    """Tests a GET request to the /doc_project/{doc_name}/preview endpoint.
    ...
    response = await client.sideko.doc.check_preview(
        doc_name="my-project", pathname="%2Freferences%my-api%2Fmy-get-documentation"
    )
    try:
        pydantic.TypeAdapter(bool).validate_python(response)
...
def test_get_200_generated_success():
    ...
    response = client.sideko.doc.get(doc_name="my-project")
    try:
        pydantic.TypeAdapter(models.DocProject).validate_python(response)
        is_json = True
    except pydantic.ValidationError:
...
async def test_await_get_200_generated_success():
    ...
    response = await client.sideko.doc.get(doc_name="my-project")
    try:
        pydantic.TypeAdapter(models.DocProject).validate_python(response)
        is_json = True
    except pydantic.ValidationError:
...
def test_list_200_generated_success():
    ...
    response = client.sideko.doc.list()
    try:
...
async def test_await_list_200_generated_success():
    ...
    response = await client.sideko.doc.list()
    try:
        pydantic.TypeAdapter(typing.List[models.DocProject]).validate_python(response)
        is_json = True
    except pydantic.ValidationError:
...
def test_delete_204_generated_success():
    ...
    response = client.sideko.doc.delete(doc_name="my-project")
...
async def test_await_delete_204_generated_success():
    ...
    response = await client.sideko.doc.delete(doc_name="my-project")
    assert response is None

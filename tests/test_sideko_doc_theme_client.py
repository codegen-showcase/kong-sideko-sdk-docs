...
def test_update_200_success_default():
    ...
    response = client.sideko.doc.theme.update(
        doc_name="my-project",
...
async def test_await_update_200_success_default():
    ...
    response = await client.sideko.doc.theme.update(
        doc_name="my-project",
        api_reference_group_variant="grouped",
        dark_active_button_bg_color="#FFFFFF",
        dark_active_button_text_color="#FFFFFF",
...
def test_get_200_generated_success():
    ...
    response = client.sideko.doc.theme.get(doc_name="my-project")
    try:
        pydantic.TypeAdapter(models.Theme).validate_python(response)
        is_json = True
    except pydantic.ValidationError:
...
async def test_await_get_200_generated_success():
    ...
    response = await client.sideko.doc.theme.get(doc_name="my-project")
    try:
        pydantic.TypeAdapter(models.Theme).validate_python(response)
        is_json = True
    except pydantic.ValidationError:

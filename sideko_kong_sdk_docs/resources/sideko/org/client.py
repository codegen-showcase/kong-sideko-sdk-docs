...
from sideko_kong_sdk_docs.resources.sideko.org.theme import (
    AsyncThemeClient,
    ThemeClient,
)
...
class OrgClient:
    ...
    def create(
        ...
        *,
        ...
        Examples:
        ```py
        client.sideko.org.create(name="My Organization", subdomain="my-org")
        ```
        """
        _json = to_encodable(
...
class AsyncOrgClient:
    ...
    async def create(
        ...
        *,
        ...
        Examples:
        ```py
        await client.sideko.org.create(name="My Organization", subdomain="my-org")
        ```
        """
        _json = to_encodable(
            item={"name": name, "subdomain": subdomain},

...
class SpecClient:
    ...
    def delete(
        ...
        *,
        ...
        Examples:
        ```py
        client.sideko.api.spec.delete(api_name="my-project", api_version="latest")
        ```
        """
    ...
    def list(
        ...
        Examples:
        ```py
        client.sideko.api.spec.list(api_name="my-project")
        ```
        """
    ...
    def get(
        ...
        *,
        ...
        Examples:
        ```py
        client.sideko.api.spec.get(api_name="my-project", api_version="latest")
        ```
        """
        return self._base_client.request(
            method="GET",
    ...
    def get_openapi(
        ...
        *,
        ...
        Examples:
        ```py
        client.sideko.api.spec.get_openapi(api_name="my-project", api_version="latest")
        ```
        """
        return self._base_client.request(
            method="GET",
    ...
    def get_stats(
        ...
        *,
        ...
        Examples:
        ```py
        client.sideko.api.spec.get_stats(api_name="my-project", api_version="latest")
        ```
        """
        return self._base_client.request(
            method="GET",
...
class AsyncSpecClient:
    ...
    async def delete(
        ...
        *,
        ...
        Examples:
        ```py
        await client.sideko.api.spec.delete(api_name="my-project", api_version="latest")
        ```
        """
    ...
    async def list(
        ...
        Examples:
        ```py
        await client.sideko.api.spec.list(api_name="my-project")
        ```
        """
    ...
    async def get(
        ...
        *,
        ...
        Examples:
        ```py
        await client.sideko.api.spec.get(api_name="my-project", api_version="latest")
        ```
        """
        return await self._base_client.request(
            method="GET",
    ...
    async def get_openapi(
        ...
        *,
        ...
        Examples:
        ```py
        await client.sideko.api.spec.get_openapi(
    ...
    async def get_stats(
        ...
        *,
        ...
        Examples:
        ```py
        await client.sideko.api.spec.get_stats(
            api_name="my-project", api_version="latest"
        )
        ```
        """
    ...
    async def patch(
        ...
        *,
        ...
        Examples:
        ```py
        await client.sideko.api.spec.patch(
            api_name="my-project",
            api_version="latest",
            notes="<p>This version includes a number of excellent improvements</p>",
            openapi=open("uploads/openapi.yaml", "rb"),
    ...
    async def create(
        ...
        *,
        ...
        Examples:
        ```py
        await client.sideko.api.spec.create(
            api_name="my-project",
            openapi=open("uploads/openapi.yaml", "rb"),
            version="major",
            notes="<p>This version includes a number of excellent improvements</p>",

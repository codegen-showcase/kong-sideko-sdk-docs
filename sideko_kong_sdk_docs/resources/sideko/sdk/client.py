...
from sideko_kong_sdk_docs.resources.sideko.sdk.config import (
    AsyncConfigClient,
    ConfigClient,
)
from sideko_kong_sdk_docs.resources.sideko.sdk.doc import AsyncDocClient, DocClient
...
class AsyncSdkClient:
    ...
    async def generate(
        ...
        *,
        ...
        Examples:
        ```py
        await client.sideko.sdk.generate(
            config=open("uploads/config.yaml", "rb"), language="go", sdk_version="0.1.0"
        )
        ```
        """
    ...
    async def update(
        ...
        *,
        ...
        Examples:
        ```py
        await client.sideko.sdk.update(
            config=open("uploads/config.yaml", "rb"),
            prev_sdk_git=open("uploads/git.tar.gz", "rb"),
            prev_sdk_id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a",
            sdk_version="major",

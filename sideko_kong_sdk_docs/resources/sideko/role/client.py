...
class RoleClient:
    ...
    def delete(
        ...
        Examples:
        ```py
        client.sideko.role.delete(id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a")
        ```
        """
...
class AsyncRoleClient:
    ...
    async def delete(
        ...
        Examples:
        ```py
        await client.sideko.role.delete(id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a")
        ```
        """
    ...
    async def create(
        ...
        *,
        ...
        Examples:
        ```py
        await client.sideko.role.create(
            object_id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a",
            object_type="api_project",
            role_definition_id="ApiProjectAdmin",
            user_id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a",

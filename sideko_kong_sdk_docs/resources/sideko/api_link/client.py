...
from sideko_kong_sdk_docs.resources.sideko.api_link.group import (
    AsyncGroupClient,
    GroupClient,
)
...
class ApiLinkClient:
    ...
    def delete(
        ...
        Examples:
        ```py
        client.sideko.api_link.delete(id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a")
        ```
        """
    ...
    def get(
        ...
        Examples:
        ```py
        client.sideko.api_link.get(id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a")
        ```
        """
        return self._base_client.request(
            method="GET",
    ...
    def patch(
        ...
        *,
        ...
        Examples:
        ```py
        client.sideko.api_link.patch(id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a")
        ```
        """
        _json = to_encodable(
            item={
    ...
    def reorder(
        ...
        *,
        ...
        Examples:
        ```py
        client.sideko.api_link.reorder(
            doc_version_id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a",
...
class AsyncApiLinkClient:
    ...
    async def delete(
        ...
        Examples:
        ```py
        await client.sideko.api_link.delete(id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a")
        ```
        """
    ...
    async def list(
        ...
        *,
        ...
        Examples:
        ```py
        await client.sideko.api_link.list(
            doc_name="my-project", doc_version="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a"
        )
        ```
        """
    ...
    async def get(
        ...
        Examples:
        ```py
        await client.sideko.api_link.get(id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a")
        ```
        """
        return await self._base_client.request(
            method="GET",
    ...
    async def patch(
        ...
        *,
        ...
        Examples:
        ```py
        await client.sideko.api_link.patch(id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a")
        ```
        """
        _json = to_encodable(
            item={
    ...
    async def create(
        ...
        *,
        ...
        Examples:
        ```py
        await client.sideko.api_link.create(
            doc_version_id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a",
            group_id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a",
            nav_label="string",
            policy={"api_id": "my-api", "type_": "latest"},
    ...
    async def reorder(
        ...
        *,
        ...
        Examples:
        ```py
        await client.sideko.api_link.reorder(
            doc_version_id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a",
            groups=[{"id": "3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a", "order": 123}],
            links=[
                {

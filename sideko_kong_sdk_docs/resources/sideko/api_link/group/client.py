...
class GroupClient:
    ...
    def delete(
        ...
        Examples:
        ```py
        client.sideko.api_link.group.delete(id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a")
        ```
        """
    ...
    def list(
        ...
        *,
        ...
        Examples:
        ```py
        client.sideko.api_link.group.list(
    ...
    def patch(
        ...
        *,
        ...
        Examples:
        ```py
        client.sideko.api_link.group.patch(id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a")
        ```
        """
        _json = to_encodable(
    ...
    def create(
        ...
        *,
        ...
        Examples:
        ```py
        client.sideko.api_link.group.create(
...
class AsyncGroupClient:
    ...
    async def delete(
        ...
        Examples:
        ```py
        await client.sideko.api_link.group.delete(
    ...
    async def list(
        ...
        *,
        ...
        Examples:
        ```py
        await client.sideko.api_link.group.list(
            doc_name="my-project", doc_version="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a"
        )
        ```
        """
    ...
    async def patch(
        ...
        *,
        ...
        Examples:
        ```py
        await client.sideko.api_link.group.patch(
            id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a"
        )
        ```
        """
    ...
    async def create(
        ...
        *,
        ...
        Examples:
        ```py
        await client.sideko.api_link.group.create(
            doc_version_id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a",
            nav_label="string",
            slug="string",
        )

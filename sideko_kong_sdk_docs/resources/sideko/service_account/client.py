...
class ServiceAccountClient:
    ...
    def delete(
        ...
        Examples:
        ```py
        client.sideko.service_account.delete(id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a")
        ```
        """
    ...
    def list(
        ...
        Examples:
        ```py
        client.sideko.service_account.list()
        ```
        """
    ...
    def get(
        ...
        Examples:
        ```py
        client.sideko.service_account.get(id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a")
        ```
        """
        return self._base_client.request(
            method="GET",
    ...
    def create(
        ...
        *,
        ...
        Examples:
        ```py
        client.sideko.service_account.create(
...
class AsyncServiceAccountClient:
    ...
    async def delete(
        ...
        Examples:
        ```py
        await client.sideko.service_account.delete(
    ...
    async def list(
        ...
        Examples:
        ```py
        await client.sideko.service_account.list()
        ```
        """
    ...
    async def get(
        ...
        Examples:
        ```py
        await client.sideko.service_account.get(
            id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a"
        )
        ```
        """
    ...
    async def create(
        ...
        *,
        ...
        Examples:
        ```py
        await client.sideko.service_account.create(
            name="Documentation Publisher Service Account",
            object_roles=[
                {
                    "object_id": "3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a",

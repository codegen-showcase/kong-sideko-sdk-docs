...
class PreviewClient:
    ...
    def delete_password(
        ...
        *,
        ...
        Examples:
        ```py
        client.sideko.doc.preview.delete_password(
    ...
    def list_passwords(
        ...
        Examples:
        ```py
        client.sideko.doc.preview.list_passwords(doc_name="my-project")
        ```
        """
    ...
    def create_password(
        ...
        *,
        ...
        Examples:
        ```py
        client.sideko.doc.preview.create_password(
            doc_name="my-project", name="My customer preview"
        )
        ```
        """
...
class AsyncPreviewClient:
    ...
    async def delete_password(
        ...
        *,
        ...
        Examples:
        ```py
        await client.sideko.doc.preview.delete_password(
            doc_name="my-project", name="My customer preview"
        )
        ```
        """
    ...
    async def list_passwords(
        ...
        Examples:
        ```py
        await client.sideko.doc.preview.list_passwords(doc_name="my-project")
        ```
        """
    ...
    async def create_password(
        ...
        *,
        ...
        Examples:
        ```py
        await client.sideko.doc.preview.create_password(
            doc_name="my-project", name="My customer preview"
        )
        ```
        """

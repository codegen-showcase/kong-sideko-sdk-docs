...
class DeploymentClient:
    ...
    def list(
        ...
        *,
        ...
        Examples:
        ```py
        client.sideko.doc.deployment.list(doc_name="my-project")
        ```
        """
        _query: QueryParams = {}
    ...
    def get(
        ...
        *,
        ...
        Examples:
        ```py
        client.sideko.doc.deployment.get(
    ...
    def trigger(
        ...
        *,
        ...
        Examples:
        ```py
        client.sideko.doc.deployment.trigger(doc_name="my-project", target="Preview")
        ```
        """
        _json = to_encodable(
...
class AsyncDeploymentClient:
    ...
    async def list(
        ...
        *,
        ...
        Examples:
        ```py
        await client.sideko.doc.deployment.list(doc_name="my-project")
        ```
        """
        _query: QueryParams = {}
        if not isinstance(limit, type_utils.NotGiven):
    ...
    async def get(
        ...
        *,
        ...
        Examples:
        ```py
        await client.sideko.doc.deployment.get(
            deployment_id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a", doc_name="my-project"
        )
        ```
        """
    ...
    async def trigger(
        ...
        *,
        ...
        Examples:
        ```py
        await client.sideko.doc.deployment.trigger(

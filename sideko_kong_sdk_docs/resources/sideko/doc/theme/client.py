...
class ThemeClient:
    ...
    def get(
        ...
        Examples:
        ```py
        client.sideko.doc.theme.get(doc_name="my-project")
        ```
        """
    ...
    def update(
        ...
        *,
        ...
        Examples:
        ```py
        client.sideko.doc.theme.update(
            doc_name="my-project",
...
class AsyncThemeClient:
    ...
    async def get(
        ...
        Examples:
        ```py
        await client.sideko.doc.theme.get(doc_name="my-project")
        ```
        """
    ...
    async def update(
        ...
        *,
        ...
        Examples:
        ```py
        await client.sideko.doc.theme.update(
            doc_name="my-project",
            api_reference_group_variant="grouped",
            dark_active_button_bg_color="#FFFFFF",
            dark_active_button_text_color="#FFFFFF",

...
from sideko_kong_sdk_docs.resources.sideko.doc.deployment import (
    AsyncDeploymentClient,
    DeploymentClient,
)
from sideko_kong_sdk_docs.resources.sideko.doc.preview import (
    AsyncPreviewClient,
    PreviewClient,
)
from sideko_kong_sdk_docs.resources.sideko.doc.theme import (
    AsyncThemeClient,
    ThemeClient,
)
from sideko_kong_sdk_docs.resources.sideko.doc.version import (
    AsyncVersionClient,
    VersionClient,
)
...
class DocClient:
    ...
    def delete(
        ...
        Examples:
        ```py
        client.sideko.doc.delete(doc_name="my-project")
        ```
        """
    ...
    def get(
        ...
        Examples:
        ```py
        client.sideko.doc.get(doc_name="my-project")
        ```
        """
        return self._base_client.request(
            method="GET",
    ...
    def check_preview(
        ...
        *,
        ...
        Examples:
        ```py
        client.sideko.doc.check_preview(
            doc_name="my-project",
    ...
    def patch(
        ...
        *,
        ...
        Examples:
        ```py
        client.sideko.doc.patch(doc_name="my-project", name="my-company-docs")
        ```
        """
        _json = to_encodable(
    ...
    def create(
        ...
        Examples:
        ```py
        client.sideko.doc.create(name="my-company-docs")
        ```
        """
        _json = to_encodable(
...
class AsyncDocClient:
    ...
    async def delete(
        ...
        Examples:
        ```py
        await client.sideko.doc.delete(doc_name="my-project")
        ```
        """
    ...
    async def get(
        ...
        Examples:
        ```py
        await client.sideko.doc.get(doc_name="my-project")
        ```
        """
        return await self._base_client.request(
            method="GET",
    ...
    async def check_preview(
        ...
        *,
        ...
        Examples:
        ```py
        await client.sideko.doc.check_preview(
            doc_name="my-project",
            pathname="%2Freferences%my-api%2Fmy-get-documentation",
        )
        ```
    ...
    async def patch(
        ...
        *,
        ...
        Examples:
        ```py
        await client.sideko.doc.patch(doc_name="my-project", name="my-company-docs")
        ```
        """
        _json = to_encodable(
            item={"logos": logos, "name": name, "settings": settings},
    ...
    async def create(
        ...
        Examples:
        ```py
        await client.sideko.doc.create(name="my-company-docs")
        ```
        """
        _json = to_encodable(
            item={"name": name}, dump_with=params._SerializerNewDocProject

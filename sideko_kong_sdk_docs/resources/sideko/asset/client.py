...
class AssetClient:
    ...
    def delete(
        ...
        Examples:
        ```py
        client.sideko.asset.delete(id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a")
        ```
        """
    ...
    def patch(
        ...
        *,
        ...
        Examples:
        ```py
        client.sideko.asset.patch(id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a")
        ```
        """
        _json = to_encodable(
    ...
    def create(
        ...
        *,
        ...
        Examples:
        ```py
        client.sideko.asset.create(file=open("uploads/image.png", "rb"))
        ```
        """
...
class AsyncAssetClient:
    ...
    async def delete(
        ...
        Examples:
        ```py
        await client.sideko.asset.delete(id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a")
        ```
        """
    ...
    async def list(
        ...
        *,
        ...
        Examples:
        ```py
        await client.sideko.asset.list()
        ```
        """
        _query: QueryParams = {}
        if not isinstance(name, type_utils.NotGiven):
    ...
    async def patch(
        ...
        *,
        ...
        Examples:
        ```py
        await client.sideko.asset.patch(id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a")
        ```
        """
        _json = to_encodable(
            item={"name": name}, dump_with=params._SerializerUpdateAsset
    ...
    async def create(
        ...
        *,
        ...
        Examples:
        ```py
        await client.sideko.asset.create(file=open("uploads/image.png", "rb"))
        ```
        """
        _data = to_encodable(item={"file": file}, dump_with=params._SerializerFile)
        _files = params._SerializerFile.get_files_from_typed_dict(

...
class LogoClient:
    ...
    def list(
        ...
        **Pre-release Endpoint**
        ...
        GET /portals/{portalId}/assets/logo
        ...
        Examples:
        ```py
        client.kong_portal.portals.assets.logo.list(
        ...
        return self._base_client.request(
            method="GET",
            path=f"/portals/{portal_id}/assets/logo",
    ...
    def update(
        ...
        **Pre-release Endpoint**
        ...
        PUT /portals/{portalId}/assets/logo
        ...
        Examples:
        ```py
        client.kong_portal.portals.assets.logo.update(
...
class AsyncLogoClient:
    ...
    async def list(
        ...
        **Pre-release Endpoint**
        ...
        Examples:
        ```py
        await client.kong_portal.portals.assets.logo.list(
            portal_id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a"
        )
        ```
        """
    ...
    async def update(
        ...
        **Pre-release Endpoint**
        ...
        Examples:
        ```py
        await client.kong_portal.portals.assets.logo.update(
            data="data:image/png;base64,bmljZV9sb29raW5nX3BpY3R1cmU=",
            portal_id="3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a",
            filename="logo.png",
        )

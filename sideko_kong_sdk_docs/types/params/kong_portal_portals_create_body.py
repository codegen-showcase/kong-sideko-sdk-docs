...
class KongPortalPortalsCreateBody(typing_extensions.TypedDict, total=False):
    """
    KongPortalPortalsCreateBody
    """
...
class _SerializerKongPortalPortalsCreateBody(pydantic.BaseModel):
    """
    Serializer for KongPortalPortalsCreateBody handling case conversions

...
class PortalSnippetsFilterParameters(typing_extensions.TypedDict, total=False):
    """
...
class _SerializerPortalSnippetsFilterParameters(pydantic.BaseModel):
    """
    Serializer for PortalSnippetsFilterParameters handling case conversions
